...
struct HelpTopic: Identifiable, Equatable {
    ...
    static let all: [HelpTopic] = [
        ...
        HelpTopic(id: "open-web", title: "Open a webpage", icon: "globe",
                  summary: "Focus the webpage field on Home and enter an article URL.",
                  shortcut: "⌘L", keywords: ["url", "article", "browser"]),
        ...
        HelpTopic(id: "ai-privacy", title: "AI context and privacy", icon: "sparkles",
                  summary: "AI is optional. Reference chips show the excerpts and attachments sent with a request; the provider handles that data under its policy.",
                  shortcut: nil, keywords: ["provider", "transmitted", "settings", "context"]),
